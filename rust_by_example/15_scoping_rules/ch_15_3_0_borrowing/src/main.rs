...
// To accomplish this, Rust uses a borrowing mechanism. Instead of passing objects by
// value (T), objects can be passed by reference (&T).
//
...
// This function takes ownership of a box and destroyed it
