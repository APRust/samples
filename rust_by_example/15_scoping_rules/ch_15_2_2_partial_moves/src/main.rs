...
// moved while other parts stay. In such a case, the parent variable cannot be
...
// deleting ref in the above code would give an error as the ownership of person.age
// would be moved to the variable age. If Person.age were stored on the stack, ref
// would not be required as the definition of age would copy the data from person.age 
// without moving it.)