...
//
// Additionally, note that returning references without input is banned if
// it would result in returning references to invalid data.
...
// in more complex case, different lifetimes may be required.
