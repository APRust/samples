...
// the original data can't be mutably borrowed. On the other hand, only
...
fn main() {
    ...
    // The immutable reference are no longer used for the rest of the code so
