...
// mutable reference and gives read/write access to the borrower.
...
// This function takes a mutable reference to a book and changes 'year' to 2014
fn new_edition(book: &mut Book) {
    book.year = 2014;
    println!("I mutable borrowed {} - {} edition", book.title, book.year);
}
...
fn main() {
    ...
    // Immutable borrow a mutable object
