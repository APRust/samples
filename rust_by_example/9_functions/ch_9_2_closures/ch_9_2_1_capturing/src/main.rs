...
fn main() {
    ...
    // 'color' can be borrowed immutable again, because the closure only holds
    ...
    // The closure still mutable borrows 'count' because it is called later.
