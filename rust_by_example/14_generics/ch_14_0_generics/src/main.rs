...
// great care to specify over which types a generic type is actually considered valid.
// The simplest and most common use of generics is for type parameters.
//
// A type parameter is specified as generic by the use of angle brackets and
// upper camel case: <Aaa, Bbb, ...>. "Generic type parameters" are typically represented as <T>.
// In Rust, "generic" also describes anything that accepts one or more generic type parameters <T>.
// Any type specified as a generic type parameter is generic,
...
// fn foo<T>(arg: T) { ... }
//
// Because T has been specified as a generic type parameter using <T>,
