...
// either yields the element T or panics. For case handling, there are many combinators
// between Result and Option that overlap.
...
// main function is able to have a return type of Result. If an error occurs within
// the main function it will return an error code and print a debug representation
// of the error (using the Debug trait):
