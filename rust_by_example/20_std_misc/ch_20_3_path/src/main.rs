...
// but instead is stored as an OsString. Therefore, converting a Path to a &str
// is not free and may fail (an Option is returned). However, a Path can be freely
// converted to an OsString or &OsStr using into_os_string and as_os_str, respectively.
