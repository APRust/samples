...
fn main() {
    ...
    // Iterate over words in reverse, no new strings is allocated
    ...
    //
    // String or character literal delimiters occurring within a literal
    // must be escaped: "\"", '\''.

    // You can use escapes to write bytes by their hexadecimal values...
    let byte_escape = "I'm writing \x52\x75\x72\x74!";
    ...
    // If you need "# in your string, just more #s in the delimiter.
    ...
    let _quotes = br#"You can also use "fancieer" formatting, \
...
// For conversion between character encoding check out the `encoding` crate
// A more detailed listing of the ways to write string literals and escape characters is
// given in the `Tokens` chapter of the Rust Reference.
