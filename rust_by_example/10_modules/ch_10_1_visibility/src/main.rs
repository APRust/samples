...
// can be overridden with the pub modifier. Only the public items of a module
...
mod my_mod {
    ...
    // Items can access other items on the same module, even when private.
...
fn main() {
    ...
    // pub(in_path) items can only be called from within the module specified
    // Error! function 'public_function_in_my_mod' is private
    // my_mod::nested::public_function_in_my_mod();

    // Private items of a module cannot be directly accessed, even if
    // nested in a public modules:
