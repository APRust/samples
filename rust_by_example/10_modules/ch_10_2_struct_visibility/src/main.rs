...
// and can be overridden with the pub modifier. This visibility only matters
// when a struct is accessed from outside the module where it is defined,
...
mod my {
    ...
    // A public struct with private field of generic type 'T'
    pub struct ClosedBox<T> {
        contents: T,
    }

    impl<T> ClosedBox<T> {
        // A public construct method
...
fn main() {
    ...
    // Error! 'CloseBox' has private fields
