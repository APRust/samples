...
// some collections into iterators using the .into_iter() method.
...
impl Iterator for Fibonacci {
    ...
    // Here, we defined the sequence using `.curr` and `.next`
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        // Since there's no endpoints to a Fibonacci sequence, the `Iterator`
