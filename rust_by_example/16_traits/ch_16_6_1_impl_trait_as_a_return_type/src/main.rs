...
// type as -> impl MyTrait. This can help simplify your type signature quite a lot!
...
// you had to allocate on the heap in order to return a closure.
...
// This makes using map and filter easier. Because closure types don't have names,
// you can't write out an explicit return type if your function returns
...
fn main() {
    ...
    println!("all done");
    println!("repeat cycle! first element again: {:?}", v3.next());
